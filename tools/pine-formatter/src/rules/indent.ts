 ...
 */
export function normalizeBlockIndent(spaces: number, indentSize = 4): number {
 ...
 */
export function safeContinuationIndent(
    blockIndent: number,
    extra = 2,
    indentSize = 4,
): number {
 ...
 */
export function isValidContinuationIndent(indent: number, indentSize = 4): boolean {
